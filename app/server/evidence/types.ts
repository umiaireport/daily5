...
export const EVIDENCE_CONTENT_VERSION = 'game-evidence-v1' as const;
export const EVIDENCE_RULES_VERSION = 'daily-five-v1' as const;
...
export interface CompiledDailyCase {
  readonly kind: 'daily-case';
  readonly caseId: string;
  readonly roundIndex: number;
  readonly sourceKind: SourceKind;
  readonly chain: string;
