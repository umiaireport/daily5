...
export interface DailyCaseCompileInput extends Omit<
  EvidenceRecordInput,
...
function attributionFor(input: DailyCaseCompileInput): readonly EvidenceAttribution[] {
...
export function compileDailyCase(
  value: DailyCaseCompileInput,
  options: CompileOptions = {},
): CompiledDailyCase {
