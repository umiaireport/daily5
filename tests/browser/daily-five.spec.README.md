...
Uses actual application services on desktop and mobile. Covers whole-card corner clicks and keyboard activation, clue selection/credits, reload, leverage, all five rounds, shares, transient resume, practice recovery, lost replies, continuation errors, countdown and 320px layout. Failures are injected only for recovery tests.
