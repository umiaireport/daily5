...
export class DailyFiveEngine {
  ...
  /** Named milestone operation for starting a persisted attempt. */
  startAttempt(
    dailyId: string,
    playerId: string,
  ...
  /** Named milestone operation for unlocking a clue within the current round. */
  unlockClue(
    playerId: string,
    attemptId: string,
  ...
  /** Exposes the named milestone operation for coordinators that wrap persistence themselves. */
  ...
  /** Exposes the named milestone operation for coordinators that aggregate saved tickets. */
